...
(
	...
	FEC_YAP		DATETIME NOT NULL DEFAULT SYSDATETIMEOFFSET() AT TIME ZONE 'SA Pacific Standard Time',
...
BEGIN
	...
	IF (@saldoCuenta IS NULL)
		BEGIN
			SELECT 'Ocurri� un problema, vuelva a iniciar sesi�n' AS [Mensaje]
			RETURN;
		END
